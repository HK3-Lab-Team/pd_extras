...
# DB_SMVET = os.path.join('/home/lorenzo-hk3lab/WorkspaceHK3Lab', 'smvet','data',
# 'Sani_15300_anonym.csv')
# SEGMENTATION_DATA = os.path.join(CWD, '..', 'segmentation', 'resources',
# 'dense_areas_percentage.csv')
